...
function newImport(artist, album, title, i, mbid, genre, length, recordId){
    ...
    a.addEventListener('click', function(){
        ...
        modalAlbum.textContent = "Album : " + album;
